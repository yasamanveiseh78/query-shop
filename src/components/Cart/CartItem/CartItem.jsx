...
function CartItem({ item }) {
  ...
  return (
    <div className="mx-auto mb-4 max-w-200 rounded-xl border border-[#e6ddd4] bg-[#fffaf5] p-4 shadow-[0_4px_14px_rgba(75,63,56,0.1)]">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-5">
        <div className="mt-4 flex h-28 w-28 shrink-0 self-center items-center justify-center rounded-lg bg-[#f7f3ed] p-3 sm:self-auto">
          <img
            src={image}
            alt={title}
        ...
        <button
          ...
          className="w-full rounded-lg px-3 py-2 text-sm font-medium text-[#c23a5c] transition hover:bg-[#f5dfe5] sm:w-auto sm:self-start"
        >
          Remove
        </button>
      </div>
