    ...
    >
      ...
      <div className="mt-auto flex flex-wrap items-center justify-between pt-4">
        ...
        <button
          ...
          className="rounded-[10px] cursor-pointer bg-[#366648] px-4 py-1.5 text-base text-[#fffaf5] transition-all duration-200 ease-in-out hover:-translate-y-0.5 hover:bg-[#d9486b] active:bg-[#c23a5c]"
        >
          Add to Cart
        </button>
      </div>
